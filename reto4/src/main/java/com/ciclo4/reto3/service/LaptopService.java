...
public class LaptopService {
    ...
    public boolean delete(int id){
       ...
       public Laptop authUser(List<Laptop> usuarios, double price) {
        Laptop u = null;
        double precio=0;
   ...
   public List<Laptop> gadgetsByPrice(double price) {
    ...
    public List<Laptop> description(List<Laptop> usuarios, String word) {
        
        List<Laptop> tmp = new ArrayList();
        Laptop u = null;
        String descripcion="";
        for (int i=0;i<usuarios.size();i++) {
            u=usuarios.get(i);
