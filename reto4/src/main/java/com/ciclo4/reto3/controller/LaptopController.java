...
public class LaptopController {
    ...
    public List<Laptop> gadgetsByPrice(@PathVariable("price") double price) {
        return laptopService.gadgetsByPrice(price);
    }
           @GetMapping("/description/{description}")
    public List<Laptop> descript(@PathVariable("description") String description) {
        List<Laptop> usuarios = laptopService.getAll();
        return laptopService.description(usuarios, description);
    }
